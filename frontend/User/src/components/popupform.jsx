...
const PopupForms = ({
  ...
  const handleSolarSubmit = async (e) => {
    ...
    const payload = {
      ...
      Energy_Generation_Value: parseFloat(solarPanelData.Energy_Generation_Value),
  ...
  const handleTreeSubmit = async (e) => {
    ...
    try {
      ...
      if (!payload.Height || isNaN(payload.Height)) missingFields.push('Height');
          ...
          <form onSubmit={handleEVSubmit}>
            <div className="form-row">
              <div className="form-group">
                ...
                <select id="EVCategory" className="form-control" value={evData.EVCategory} onChange={(e) => setEVData({ ...evData, EVCategory: e.target.value })} required>
              ...
              <div className="form-group">
                ...
                <input type="text" id="ev-manufacturer" className="form-control" placeholder="e.g., Tesla, Nissan, Chevrolet" value={evData.manufacturer} onChange={(e) => setEVData({ ...evData, manufacturer: e.target.value })} required />
              </div>
            </div>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input type="text" id="ev-model" className="form-control" placeholder="e.g., Model 3, Leaf, Bolt" value={evData.model} onChange={(e) => setEVData({ ...evData, model: e.target.value })} required />
              </div>
              <div className="form-group">
                <label htmlFor="ev-year">Purchase Year</label>
                <input type="number" id="ev-year" className="form-control" placeholder="e.g., 2022" min="2000" max="2030" value={evData.year} onChange={(e) => setEVData({ ...evData, year: e.target.value })} required />
              </div>
            </div>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input type="number" id="energyconsumed" className="form-control" placeholder="e.g., 75" step="0.1" min="1" value={evData.batteryconsumed} onChange={(e) => setEVData({ ...evData, batteryconsumed: e.target.value })} required />
              </div>
              <div className="form-group">
                <label htmlFor="chargingType">Primary Charging Type</label>
                <select id="chargingType" className="form-control" value={evData.chargingType} onChange={(e) => setEVData({ ...evData, chargingType: e.target.value })} required>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input type="number" id="range" className="form-control" placeholder="e.g., 300" min="1" value={evData.range} onChange={(e) => setEVData({ ...evData, range: e.target.value })} required />
              </div>
              <div className="form-group">
                <label htmlFor="gridEmissionFactor">Grid Emission Factor</label>
                <input type="number" id="gridEmissionFactor" className="form-control" placeholder="e.g., 0.5" step="0.1" min="0" value={evData.gridEmissionFactor} onChange={(e) => setEVData({ ...evData, gridEmissionFactor: e.target.value })} required />
              </div>
            </div>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input type="number" id="topSpeed" className="form-control" placeholder="e.g., 180" min="0" value={evData.topSpeed} onChange={(e) => setEVData({ ...evData, topSpeed: e.target.value })} />
              </div>
              <div className="form-group">
                <label htmlFor="chargingTime">Charging time (hours)</label>
                <input type="number" id="chargingTime" className="form-control" placeholder="e.g., 8" step="0.5" min="0" value={evData.chargingTime} onChange={(e) => setEVData({ ...evData, chargingTime: e.target.value })} />
              </div>
              <div className="form-group">
                <label htmlFor="motorpower">Motor power (HP)</label>
                <input type="text" id="motorpower" className="form-control" placeholder="e.g., 200 HP" value={evData.motorpower} onChange={(e) => setEVData({ ...evData, motorpower: e.target.value })} />
              </div>
            </div>
          ...
          <form onSubmit={handleSolarSubmit}>
            <div className="form-row">
              <div className="form-group">
                ...
                <input type="number" id="Installed_Capacity" className="form-control" placeholder="e.g., 5" step="0.1" value={solarPanelData.Installed_Capacity} onChange={(e) => setSolarPanelData({ ...solarPanelData, Installed_Capacity: e.target.value })} required />
              </div>
              <div className="form-group">
                <label htmlFor="Installation_Date">Installation Date</label>
                <input type="date" id="Installation_Date" className="form-control" value={solarPanelData.Installation_Date} onChange={(e) => setSolarPanelData({ ...solarPanelData, Installation_Date: e.target.value })} required />
              </div>
            </div>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input type="number" id="Energy_Generation_Value" className="form-control" placeholder="e.g., 150" step="0.1" value={solarPanelData.Energy_Generation_Value} onChange={(e) => setSolarPanelData({ ...solarPanelData, Energy_Generation_Value: e.target.value })} required />
              </div>
              <div className="form-group">
                <label htmlFor="Grid_Emission_Factor">Grid Emission Factor</label>
                <input type="number" id="Grid_Emission_Factor" className="form-control" placeholder="e.g., 0.7" step="0.1" value={solarPanelData.Grid_Emission_Factor} onChange={(e) => setSolarPanelData({ ...solarPanelData, Grid_Emission_Factor: e.target.value })} required />
              </div>
            </div>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <select id="Inverter_Type" className="form-control" value={solarPanelData.Inverter_Type} onChange={(e) => setSolarPanelData({ ...solarPanelData, Inverter_Type: e.target.value })} required>
          ...
          <form onSubmit={handleTreeSubmit}>
            <div className="form-row">
              <div className="form-group">
                ...
                <input type="text" id="TreeName" className="form-control" placeholder="e.g., Mango, Pine, Neem" value={treeData.TreeName} onChange={(e) => setTreeData({ ...treeData, TreeName: e.target.value })} required />
              </div>
              <div className="form-group">
                <label htmlFor="BotanicalName">Botanical Name</label>
                <input type="text" id="BotanicalName" className="form-control" placeholder="e.g., Mangifera indica" value={treeData.BotanicalName} onChange={(e) => setTreeData({ ...treeData, BotanicalName: e.target.value })} required />
              </div>
            </div>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input type="date" id="PlantingDate" className="form-control" value={treeData.PlantingDate} onChange={(e) => setTreeData({ ...treeData, PlantingDate: e.target.value })} required />
              </div>
              <div className="form-group">
                <label htmlFor="Height">Height (cm)</label>
                <input type="number" id="Height" className="form-control" placeholder="e.g., 250" value={treeData.Height} onChange={(e) => setTreeData({ ...treeData, Height: e.target.value })} required />
              </div>
            </div>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input type="text" id="location" className="form-control" placeholder="e.g., Backyard, Community Garden" value={treeData.location} onChange={(e) => setTreeData({ ...treeData, location: e.target.value })} required />
              </div>
            </div>
